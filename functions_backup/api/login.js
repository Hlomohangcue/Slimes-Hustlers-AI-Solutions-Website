export async function onRequest(context) {
  ...
  try {
    ...
    // ADMIN_PASSWORD: secret used to authenticate. ADMIN_TOKEN is the value set in cookie.
    ...
    // Set auth cookie (HttpOnly, Secure). Client will be redirected after login.
